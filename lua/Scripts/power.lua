...
-- polynomials coefficients describing EEC power limits as from FCOM tables found by polynomial calculator https://arachnoid.com/polysolve/
local power_eec = {
	["TO"] = {
		["off"] = {
			[-1000] = { 1.4651322783381240e+000, -1.2083333464087584e-002,  1.6534392855083708e-005 },
			[00000] = { 1.3777008176256318e+000, -1.0369167865556111e-002,  3.0062529770558575e-006 },
			[01000] = { 1.3286902357025838e+000, -1.0243265990798132e-002,  6.3131312495938996e-006 },
			[02000] = { 1.2789898998182885e+000, -9.9428904846324932e-003,  6.7987573135876872e-006 },
			[03000] = { 1.2285594958447470e+000, -9.6174658540122120e-003,  7.5618823614386812e-006 },
			[04000] = { 1.1733626374919233e+000, -8.9104853556282986e-003,  2.8617217203110213e-006 },
			[05000] = { 1.1210511025427103e+000, -8.2500448925832155e-003, -1.8180348617103351e-006 },
			[06000] = { 1.0552353514783970e+000, -6.4974271899404940e-003, -2.5136882183645786e-005 },
			[07000] = { 1.0049590643203514e+000, -5.5762512337834448e-003, -3.7499050663587706e-005 },
			[08000] = { 9.6406299015561847e-001, -5.3645460824745875e-003, -3.6608319215838928e-005 },
			[08500] = { 9.4442497213433696e-001, -5.3464325533041715e-003, -3.3491267188313021e-005 }
		},
	},
}		
...
function eec(ind)
	...
	if eng_eec[ind] == 1 and cla > 33.7 and eng_autofeather[ind] ~= 2 then
		...
		if pla < 45 then
			...
			-- EEC limits max power by ITT based on OAT and pressure altitude
			eec_limit = polyn.lookup(pressure_alt, xdref["air_temperature"][0], eec_curve)
			
			--if pdref["power"]["adc_ias"][0] > 
			if eec_limit < 1 then
